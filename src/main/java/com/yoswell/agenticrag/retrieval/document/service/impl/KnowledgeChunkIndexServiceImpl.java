 ...
 */
@Service
public class KnowledgeChunkIndexServiceImpl implements KnowledgeChunkIndexService {

    private static final Logger log = LoggerFactory.getLogger(KnowledgeChunkIndexServiceImpl.class);
    ...
    public KnowledgeChunkIndexServiceImpl(RestClient restClient,
