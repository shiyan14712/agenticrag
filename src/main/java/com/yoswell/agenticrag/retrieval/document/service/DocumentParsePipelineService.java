 ...
 */
@Service
public class DocumentParsePipelineService {

    private static final Logger log = LoggerFactory.getLogger(DocumentParsePipelineService.class);
    ...
    public DocumentParsePipelineService(MinioStorageService minioStorageService,
     ...
     * @return 执行结果
     */
    public ParseDispatchResult parseAndDispatch(DocumentParseRequestDTO request) {
        ...
        return new ParseDispatchResult(markdownFileUrl, parseResult.mineruTaskId(), vectorizeTask.getTaskId(), vectorizeMessageId);
    }
    ...
    public record ParseDispatchResult(String markdownFileUrl,
                                      String mineruTaskId,
