 ...
 */
@Service
public class MineruDocumentParseService {
    ...
    public MineruDocumentParseService(MineruProperties mineruProperties, ObjectMapper objectMapper) {
    ...
    public record ParseResult(String markdown, String mineruTaskId) {
    }
