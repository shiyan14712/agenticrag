...
public class AiServiceConfig {
    ...
    @Bean
    public EnterpriseAgent enterpriseAgent(StreamingChatModel streamingChatModel,
                                           ChatMemoryProvider chatMemoryProvider,
                                           RagTool ragTool,
                                           PreferenceTool preferenceTool) {
        return AiServices.builder(EnterpriseAgent.class)
                .streamingChatModel(streamingChatModel)
                .chatMemoryProvider(chatMemoryProvider)
                .tools(ragTool, preferenceTool)
                .build();
    }
